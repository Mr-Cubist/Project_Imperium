...
public class EntityMarlingar extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 108;
	public static final int ENTITYID_RANGED = 109;
	public EntityMarlingar(ElementsXenoclusOne instance) {
		super(instance, 426);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("xenoclus_v", "marlingar"), ENTITYID).name("marlingar").tracker(67, 3, true).egg(-16763905, -205).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 5, 1, 4, EnumCreatureType.MONSTER, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelFinglar(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/swordfinglar.png");
				}
			};
		});
	}
