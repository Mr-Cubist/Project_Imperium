...
public class EntityFleeFish2 extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 36;
	public static final int ENTITYID_RANGED = 37;
	public EntityFleeFish2(ElementsXenoclusOne instance) {
		super(instance, 431);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "fleefish2"), ENTITYID)
						.name("fleefish2").tracker(64, 3, true).egg(-10027009, -3342337).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelFleeFish(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/fleefishcopy2.png");
				}
			};
		});
	}
