...
public class EntityDepthFinglar extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 106;
	public static final int ENTITYID_RANGED = 107;
	public EntityDepthFinglar(ElementsXenoclusOne instance) {
		super(instance, 437);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "depthfinglar"), ENTITYID)
						.name("depthfinglar").tracker(68, 3, true).egg(-13421773, -13369345).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelFinglar(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/depthfinglar.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void applyEntityAttributes() {
			...
			if (this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(42D);
