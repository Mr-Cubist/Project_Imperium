...
public class EntityFleeFish1 extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 34;
	public static final int ENTITYID_RANGED = 35;
	public EntityFleeFish1(ElementsXenoclusOne instance) {
		super(instance, 417);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "fleefish1"), ENTITYID)
						.name("fleefish1").tracker(64, 3, true).egg(-10053121, -3355393).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 1, 2, 3, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelFleeFish(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/fleefishcopy.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreature {
		...
		protected void initEntityAI() {
			super.initEntityAI();
			this.tasks.addTask(1, new EntityAIWander(this, 0.7, 20) {
				@Override
