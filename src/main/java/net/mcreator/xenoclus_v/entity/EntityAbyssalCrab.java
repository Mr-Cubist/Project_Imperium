...
public class EntityAbyssalCrab extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 110;
	public static final int ENTITYID_RANGED = 111;
	public EntityAbyssalCrab(ElementsXenoclusOne instance) {
		super(instance, 436);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "abyssalcrab"), ENTITYID)
						.name("abyssalcrab").tracker(64, 3, true).egg(-13421773, -16737793).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 8, 2, 5, EnumCreatureType.MONSTER, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCrab(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/abyssalcrab.png");
				}
			};
		});
	}
