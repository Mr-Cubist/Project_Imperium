...
import net.mcreator.xenoclus_v.procedure.ProcedurePotionRainNauseaJellober;
import net.mcreator.xenoclus_v.ElementsXenoclusOne;

import java.util.Random;

@ElementsXenoclusOne.ModElement.Tag
public class EntityArcticJellober extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 59;
	public static final int ENTITYID_RANGED = 60;
	public EntityArcticJellober(ElementsXenoclusOne instance) {
		super(instance, 415);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "arcticjellober"), ENTITYID)
						.name("arcticjellober").tracker(64, 3, true).egg(-26215, -13159).build());
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("xenoclus_v", "entitybulletarcticjellober"), ENTITYID_RANGED).name("entitybulletarcticjellober")
				.tracker(64, 1, true).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:insanemountains")),
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelJellyfish(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/jellyfishcopy.png");
				}
			};
		});
	...
	public static class EntityCustom extends EntityMob implements IRangedAttackMob {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(3, new EntityAIPanic(this, 0.5));
			this.tasks.addTask(4, new EntityAIWander(this, 0.4, 20) {
				@Override
		...
		public void fall(float l, float d) {
			...
			Entity entity = this;
			{
				...
				ProcedurePotionRainNauseaJellober.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelJellyfish extends ModelBase {
		...
		public ModelJellyfish() {
			...
			body.cubeList.add(new ModelBox(body, 0, 0, -5.0F, -3.0F, -5.0F, 10, 6, 10, 0.0F, false));
			Tentacles = new ModelRenderer(this);
			Tentacles.setRotationPoint(0.0F, 12.0F, 0.0F);
			Tentacles.cubeList.add(new ModelBox(Tentacles, 0, 16, -4.0F, -2.0F, -4.0F, 8, 13, 8, 0.0F, false));
		}
