...
public class EntityGlassting extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 116;
	public static final int ENTITYID_RANGED = 117;
	public EntityGlassting(ElementsXenoclusOne instance) {
		super(instance, 432);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("xenoclus_v", "glassting"), ENTITYID).name("glassting").tracker(65, 3, true).egg(-1, -3342337).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:abyssalbasic")),};
		EntityRegistry.addSpawn(EntityCustom.class, 5, 2, 3, EnumCreatureType.CREATURE, spawnBiomes);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelStingray(), 0.2f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/stingray.png");
				}
			};
		});
	}
