...
public class EntityArmoredFrusk extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 48;
	public static final int ENTITYID_RANGED = 49;
	public EntityArmoredFrusk(ElementsXenoclusOne instance) {
		super(instance, 409);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "armoredfrusk"), ENTITYID)
						.name("armoredfrusk").tracker(64, 3, true).egg(-6749953, -3342337).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelFrusk(), 0.6f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/armoredfrusk.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void applyEntityAttributes() {
			...
			if (this.getEntityAttribute(SharedMonsterAttributes.ARMOR) != null)
				this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(1.2000000000000002D);
