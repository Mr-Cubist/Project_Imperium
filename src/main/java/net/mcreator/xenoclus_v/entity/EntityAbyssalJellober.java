...
public class EntityAbyssalJellober extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 90;
	public static final int ENTITYID_RANGED = 91;
	public EntityAbyssalJellober(ElementsXenoclusOne instance) {
		super(instance, 433);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "abyssaljellober"), ENTITYID)
						.name("abyssaljellober").tracker(64, 3, true).egg(-16777165, -10040065).build());
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("xenoclus_v", "entitybulletabyssaljellober"), ENTITYID_RANGED).name("entitybulletabyssaljellober")
				.tracker(64, 1, true).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:depthfalls")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:abyssalbasic")),};
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelJellyfish(), 0.7f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/abyssaljelly.png");
				}
			};
		});
