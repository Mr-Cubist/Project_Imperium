...
public class EntityFleeFish3 extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 38;
	public static final int ENTITYID_RANGED = 39;
	public EntityFleeFish3(ElementsXenoclusOne instance) {
		super(instance, 418);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "fleefish3"), ENTITYID)
						.name("fleefish3").tracker(64, 3, true).egg(-16751104, -13408768).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelFleeFish(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/fleefishcopy3.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreature {
		...
		protected void initEntityAI() {
			super.initEntityAI();
			this.tasks.addTask(1, new EntityAIWander(this, 0.6, 20) {
				@Override
