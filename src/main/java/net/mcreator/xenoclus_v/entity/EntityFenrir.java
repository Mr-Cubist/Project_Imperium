...
public class EntityFenrir extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 92;
	public static final int ENTITYID_RANGED = 93;
	public EntityFenrir(ElementsXenoclusOne instance) {
		super(instance, 413);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "fenrir"), ENTITYID)
				.name("fenrir").tracker(64, 3, true).egg(-6710887, -3355444).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:borealforest")),
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelWerewolf(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/whitewerewolfskin.png");
				}
			};
		});
	}
