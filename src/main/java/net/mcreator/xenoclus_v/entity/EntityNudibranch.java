...
public class EntityNudibranch extends ElementsXenoclusOne.ModElement {
	public static final int ENTITYID = 68;
	public static final int ENTITYID_RANGED = 69;
	public EntityNudibranch(ElementsXenoclusOne instance) {
		super(instance, 421);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("xenoclus_v", "nudibranch"), ENTITYID)
						.name("nudibranch").tracker(64, 3, true).egg(-6749953, -13312).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:brightreef")),};
		EntityRegistry.addSpawn(EntityCustom.class, 7, 2, 3, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelSlug(), 0.3f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("xenoclus_v:textures/nudibranch.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreature {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(5, new EntityAIPanic(this, 0.4));
		}
