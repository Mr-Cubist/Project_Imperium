...
package net.mcreator.xenoclus_v.world;
...
import net.mcreator.xenoclus_v.procedure.ProcedureBorealarkAchievementPro;
import net.mcreator.xenoclus_v.item.ItemBorealark;
import net.mcreator.xenoclus_v.block.BlockBorealarkDirt;
...
public class WorldBorealark extends ElementsXenoclusOne.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("xenoclus_v:borealark_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldBorealark(ElementsXenoclusOne instance) {
		super(instance, 383);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemBorealark().setUnlocalizedName("borealark").setRegistryName("borealark"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension borealark is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("borealark", "_borealark", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemBorealark.block, 0, new ModelResourceLocation("xenoclus_v:borealark", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("xenoclus_v:BorealarkNight", (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation(("xenoclus_v:BorealarkNight"))), 6000, 24000);
		}
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureBorealarkAchievementPro.executeProcedure($_dependencies);
			}
		}
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? Blocks.PACKED_ICE.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.PACKED_ICE.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("borealark_portal");
			setRegistryName("borealark_portal");
			setLightLevel(0.54F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.PACKED_ICE.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.PACKED_ICE.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.PACKED_ICE.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.PACKED_ICE
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockBorealStone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockBorealarkDirt.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:borealarkplains")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:iceplains")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:borealarkmountains1")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:borealforest")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:frozencity")),};
