...
public class BiomeUmbraMountains extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:umbramountains")
	public static final BiomeGenCustom biome = null;
	public BiomeUmbraMountains(ElementsXenoclusOne instance) {
		super(instance, 548);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Umbra Mountains").setRainfall(0.6F).setBaseHeight(0.65F).setWaterColor(-16751104)
					.setHeightVariation(0.21F).setTemperature(0.47F));
			setRegistryName("umbramountains");
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		protected boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock()
					|| blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == BlockUmbraGrass.block.getDefaultState().getBlock()
