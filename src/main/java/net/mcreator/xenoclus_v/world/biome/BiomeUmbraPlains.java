...
public class BiomeUmbraPlains extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:umbraplains")
	public static final BiomeGenCustom biome = null;
	public BiomeUmbraPlains(ElementsXenoclusOne instance) {
		super(instance, 452);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Umbra Plains").setRainfall(0.5F).setBaseHeight(0.1F).setWaterColor(-16711936).setHeightVariation(0.2F)
					.setTemperature(0.5F));
			setRegistryName("umbraplains");
