...
public class BiomeTropicalO extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:tropicalo")
	public static final BiomeGenCustom biome = null;
	public BiomeTropicalO(ElementsXenoclusOne instance) {
		super(instance, 494);
	}
	...
	public void init(FMLInitializationEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.BEACH, BiomeDictionary.Type.JUNGLE);
		BiomeManager.addSpawnBiome(biome);
		BiomeManager.addBiome(BiomeManager.BiomeType.DESERT, new BiomeManager.BiomeEntry(biome, 3));
	}
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Tropics").setRainfall(0.7000000000000001F).setBaseHeight(0.09F).setWaterColor(-16711681)
					.setHeightVariation(0.18F).setTemperature(0.6F));
			setRegistryName("tropicalo");
			...
			decorator.sandPatchesPerChunk = 24;
