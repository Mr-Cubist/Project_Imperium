...
public class BiomeSoulDesert extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:souldesert")
	public static final BiomeGenCustom biome = null;
	public BiomeSoulDesert(ElementsXenoclusOne instance) {
		super(instance, 476);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Soul Desert").setRainfall(0.5F).setBaseHeight(0.1F).setWaterColor(-10079488).setHeightVariation(0.2F)
					.setTemperature(0.5F));
			setRegistryName("souldesert");
		...
		public boolean generate(World world, Random rand, BlockPos position) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == Blocks.SOUL_SAND.getDefaultState().getBlock() || ground == Blocks.SOUL_SAND.getDefaultState().getBlock())
