...
import net.mcreator.xenoclus_v.procedure.ProcedureAzathothAchievementGet;
import net.mcreator.xenoclus_v.item.ItemAzathoth;
import net.mcreator.xenoclus_v.block.BlockWhiteSand;
import net.mcreator.xenoclus_v.block.BlockRoseStone;
...
public class WorldAzathoth extends ElementsXenoclusOne.ModElement {
	public static int DIMID = 5;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("xenoclus_v:azathoth_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldAzathoth(ElementsXenoclusOne instance) {
		super(instance, 196);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemAzathoth().setUnlocalizedName("azathoth").setRegistryName("azathoth"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension azathoth is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("azathoth", "_azathoth", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemAzathoth.block, 0, new ModelResourceLocation("xenoclus_v:azathoth", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("xenoclus_v:AzathothSurface", (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation(("xenoclus_v:AzathothSurface"))), 6000, 24000);
		}
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureAzathothAchievementGet.executeProcedure($_dependencies);
			}
		}
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? Blocks.PRISMARINE.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.PRISMARINE.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("azathoth_portal");
			setRegistryName("azathoth_portal");
			setLightLevel(0.7F);
		}
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.PRISMARINE.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.PRISMARINE.getDefaultState().getBlock() ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.PRISMARINE.getDefaultState().getBlock()) {
								break label56;
							}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockRoseStone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockWhiteSand.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:azathothaquabeach")),
