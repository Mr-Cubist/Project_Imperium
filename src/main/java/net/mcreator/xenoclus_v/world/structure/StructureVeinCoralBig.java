...
public class StructureVeinCoralBig extends ElementsXenoclusOne.ModElement {
	public StructureVeinCoralBig(ElementsXenoclusOne instance) {
		super(instance, 659);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "vaincoral"));
				if (template == null)
					return;
