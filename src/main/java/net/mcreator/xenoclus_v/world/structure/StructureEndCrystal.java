...
public class StructureEndCrystal extends ElementsXenoclusOne.ModElement {
	public StructureEndCrystal(ElementsXenoclusOne instance) {
		super(instance, 665);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 9969) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "endcrystal"));
				if (template == null)
					return;
