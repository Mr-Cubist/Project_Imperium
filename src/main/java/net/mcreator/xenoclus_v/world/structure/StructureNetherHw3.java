...
public class StructureNetherHw3 extends ElementsXenoclusOne.ModElement {
	public StructureNetherHw3(ElementsXenoclusOne instance) {
		super(instance, 451);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 7500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "nether_hw3"));
				if (template == null)
					return;
