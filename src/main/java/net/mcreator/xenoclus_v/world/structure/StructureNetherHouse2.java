...
public class StructureNetherHouse2 extends ElementsXenoclusOne.ModElement {
	public StructureNetherHouse2(ElementsXenoclusOne instance) {
		super(instance, 448);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 9500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "nether_house2"));
				if (template == null)
					return;
