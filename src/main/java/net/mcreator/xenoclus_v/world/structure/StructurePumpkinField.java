...
public class StructurePumpkinField extends ElementsXenoclusOne.ModElement {
	public StructurePumpkinField(ElementsXenoclusOne instance) {
		super(instance, 462);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "pumpkinfield"));
				if (template == null)
					return;
