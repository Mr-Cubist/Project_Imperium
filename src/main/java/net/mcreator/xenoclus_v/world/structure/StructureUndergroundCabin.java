...
public class StructureUndergroundCabin extends ElementsXenoclusOne.ModElement {
	public StructureUndergroundCabin(ElementsXenoclusOne instance) {
		super(instance, 443);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 7000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "cabin"));
				if (template == null)
					return;
