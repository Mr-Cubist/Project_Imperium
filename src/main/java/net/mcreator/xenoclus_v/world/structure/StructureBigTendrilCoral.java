...
public class StructureBigTendrilCoral extends ElementsXenoclusOne.ModElement {
	public StructureBigTendrilCoral(ElementsXenoclusOne instance) {
		super(instance, 660);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "tendrilcoral"));
				if (template == null)
					return;
