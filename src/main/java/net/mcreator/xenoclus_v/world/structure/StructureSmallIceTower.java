...
public class StructureSmallIceTower extends ElementsXenoclusOne.ModElement {
	public StructureSmallIceTower(ElementsXenoclusOne instance) {
		super(instance, 632);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8999) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "icecastleone"));
				if (template == null)
					return;
