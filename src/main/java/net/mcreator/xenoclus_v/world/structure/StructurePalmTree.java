...
public class StructurePalmTree extends ElementsXenoclusOne.ModElement {
	public StructurePalmTree(ElementsXenoclusOne instance) {
		super(instance, 726);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 600500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "palm_tree"));
				if (template == null)
					return;
