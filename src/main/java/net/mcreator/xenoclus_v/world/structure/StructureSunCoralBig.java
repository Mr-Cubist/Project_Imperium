...
public class StructureSunCoralBig extends ElementsXenoclusOne.ModElement {
	public StructureSunCoralBig(ElementsXenoclusOne instance) {
		super(instance, 661);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "suncoral"));
				if (template == null)
					return;
