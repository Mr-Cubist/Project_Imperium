...
public class StructureBorealarkVaseCache extends ElementsXenoclusOne.ModElement {
	public StructureBorealarkVaseCache(ElementsXenoclusOne instance) {
		super(instance, 625);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 9000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "borealarkvasecache"));
				if (template == null)
					return;
