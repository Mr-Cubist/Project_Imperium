...
public class StructureCatacombSmall extends ElementsXenoclusOne.ModElement {
	public StructureCatacombSmall(ElementsXenoclusOne instance) {
		super(instance, 482);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 7000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "catacomb"));
				if (template == null)
					return;
