...
public class StructureFactoryBig extends ElementsXenoclusOne.ModElement {
	public StructureFactoryBig(ElementsXenoclusOne instance) {
		super(instance, 616);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 6999) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "factoryone"));
				if (template == null)
					return;
