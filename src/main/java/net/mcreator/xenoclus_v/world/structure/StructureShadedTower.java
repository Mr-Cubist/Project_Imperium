...
public class StructureShadedTower extends ElementsXenoclusOne.ModElement {
	public StructureShadedTower(ElementsXenoclusOne instance) {
		super(instance, 479);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 5000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "shadedtower"));
				if (template == null)
					return;
