...
public class StructureExcecutionSite extends ElementsXenoclusOne.ModElement {
	public StructureExcecutionSite(ElementsXenoclusOne instance) {
		super(instance, 458);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 6000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "execution_s"));
				if (template == null)
					return;
