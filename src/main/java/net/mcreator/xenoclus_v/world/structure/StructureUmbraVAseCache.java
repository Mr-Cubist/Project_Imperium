...
public class StructureUmbraVAseCache extends ElementsXenoclusOne.ModElement {
	public StructureUmbraVAseCache(ElementsXenoclusOne instance) {
		super(instance, 477);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "umbravasecache"));
				if (template == null)
					return;
