...
public class StructureUnderGroundforest1 extends ElementsXenoclusOne.ModElement {
	public StructureUnderGroundforest1(ElementsXenoclusOne instance) {
		super(instance, 484);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "forestunder"));
				if (template == null)
					return;
