...
public class StructurePaintedWillow extends ElementsXenoclusOne.ModElement {
	public StructurePaintedWillow(ElementsXenoclusOne instance) {
		super(instance, 543);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 120950) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "paintedwillow"));
				if (template == null)
					return;
