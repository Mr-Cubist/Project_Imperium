...
public class StructureRopeCabin extends ElementsXenoclusOne.ModElement {
	public StructureRopeCabin(ElementsXenoclusOne instance) {
		super(instance, 445);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "rope_cabin"));
				if (template == null)
					return;
