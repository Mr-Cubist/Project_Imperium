...
public class StructurePetRockStructure extends ElementsXenoclusOne.ModElement {
	public StructurePetRockStructure(ElementsXenoclusOne instance) {
		super(instance, 611);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "petrock"));
				if (template == null)
					return;
