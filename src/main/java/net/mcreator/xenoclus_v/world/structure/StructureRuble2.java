...
public class StructureRuble2 extends ElementsXenoclusOne.ModElement {
	public StructureRuble2(ElementsXenoclusOne instance) {
		super(instance, 574);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 159000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "ruble2"));
				if (template == null)
					return;
