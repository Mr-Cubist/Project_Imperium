...
public class StructureMediumBuilding extends ElementsXenoclusOne.ModElement {
	public StructureMediumBuilding(ElementsXenoclusOne instance) {
		super(instance, 575);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 20000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "mediumbuilding"));
				if (template == null)
					return;
