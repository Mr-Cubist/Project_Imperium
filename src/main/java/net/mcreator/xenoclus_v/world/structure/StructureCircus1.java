...
public class StructureCircus1 extends ElementsXenoclusOne.ModElement {
	public StructureCircus1(ElementsXenoclusOne instance) {
		super(instance, 486);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 7000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "circus1"));
				if (template == null)
					return;
