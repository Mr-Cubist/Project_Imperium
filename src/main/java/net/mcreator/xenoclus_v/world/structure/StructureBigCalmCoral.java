...
public class StructureBigCalmCoral extends ElementsXenoclusOne.ModElement {
	public StructureBigCalmCoral(ElementsXenoclusOne instance) {
		super(instance, 658);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "calmcoral"));
				if (template == null)
					return;
