...
public class StructureUmbraCastle extends ElementsXenoclusOne.ModElement {
	public StructureUmbraCastle(ElementsXenoclusOne instance) {
		super(instance, 488);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "umbracastle"));
				if (template == null)
					return;
