...
public class StructureSaltshipwrecktwo extends ElementsXenoclusOne.ModElement {
	public StructureSaltshipwrecktwo(ElementsXenoclusOne instance) {
		super(instance, 672);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "salt_ship_one"));
				if (template == null)
					return;
