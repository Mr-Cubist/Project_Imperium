...
public class StructureDuskCoralBig extends ElementsXenoclusOne.ModElement {
	public StructureDuskCoralBig(ElementsXenoclusOne instance) {
		super(instance, 657);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "duskcoral"));
				if (template == null)
					return;
