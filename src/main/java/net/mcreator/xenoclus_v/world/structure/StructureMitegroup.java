...
public class StructureMitegroup extends ElementsXenoclusOne.ModElement {
	public StructureMitegroup(ElementsXenoclusOne instance) {
		super(instance, 668);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 9970) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "mitegroup"));
				if (template == null)
					return;
