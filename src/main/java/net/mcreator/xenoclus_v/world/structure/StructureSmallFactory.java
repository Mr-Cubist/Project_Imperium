...
public class StructureSmallFactory extends ElementsXenoclusOne.ModElement {
	public StructureSmallFactory(ElementsXenoclusOne instance) {
		super(instance, 624);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8999) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "smallfactory"));
				if (template == null)
					return;
