...
public class StructureNetherHw1 extends ElementsXenoclusOne.ModElement {
	public StructureNetherHw1(ElementsXenoclusOne instance) {
		super(instance, 449);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "nether_highway1"));
				if (template == null)
					return;
