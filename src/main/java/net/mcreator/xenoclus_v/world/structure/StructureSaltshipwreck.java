...
public class StructureSaltshipwreck extends ElementsXenoclusOne.ModElement {
	public StructureSaltshipwreck(ElementsXenoclusOne instance) {
		super(instance, 671);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "salt_ship_wreck"));
				if (template == null)
					return;
