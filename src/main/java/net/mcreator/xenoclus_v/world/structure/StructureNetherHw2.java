...
public class StructureNetherHw2 extends ElementsXenoclusOne.ModElement {
	public StructureNetherHw2(ElementsXenoclusOne instance) {
		super(instance, 450);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "nether_hw2"));
				if (template == null)
					return;
