...
public class StructureRibcage extends ElementsXenoclusOne.ModElement {
	public StructureRibcage(ElementsXenoclusOne instance) {
		super(instance, 463);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 9000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "ribcage"));
				if (template == null)
					return;
