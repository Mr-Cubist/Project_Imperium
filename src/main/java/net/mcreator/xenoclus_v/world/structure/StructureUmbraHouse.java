...
public class StructureUmbraHouse extends ElementsXenoclusOne.ModElement {
	public StructureUmbraHouse(ElementsXenoclusOne instance) {
		super(instance, 457);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "umbra_house"));
				if (template == null)
					return;
