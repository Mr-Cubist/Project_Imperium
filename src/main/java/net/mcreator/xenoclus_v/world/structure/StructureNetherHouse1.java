...
public class StructureNetherHouse1 extends ElementsXenoclusOne.ModElement {
	public StructureNetherHouse1(ElementsXenoclusOne instance) {
		super(instance, 447);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 9500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "nether_house1"));
				if (template == null)
					return;
