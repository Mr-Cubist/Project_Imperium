...
public class StructureUnderGroundEBONYFOREST2 extends ElementsXenoclusOne.ModElement {
	public StructureUnderGroundEBONYFOREST2(ElementsXenoclusOne instance) {
		super(instance, 485);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 6000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "undertree"));
				if (template == null)
					return;
