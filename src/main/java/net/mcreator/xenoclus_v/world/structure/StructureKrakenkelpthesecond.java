...
public class StructureKrakenkelpthesecond extends ElementsXenoclusOne.ModElement {
	public StructureKrakenkelpthesecond(ElementsXenoclusOne instance) {
		super(instance, 794);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "krakenkelp"));
				if (template == null)
					return;
