...
public class StructureLargeIceTower extends ElementsXenoclusOne.ModElement {
	public StructureLargeIceTower(ElementsXenoclusOne instance) {
		super(instance, 633);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 7999) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "largeicetower"));
				if (template == null)
					return;
