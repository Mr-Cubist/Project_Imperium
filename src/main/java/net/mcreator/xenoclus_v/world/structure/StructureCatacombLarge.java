...
public class StructureCatacombLarge extends ElementsXenoclusOne.ModElement {
	public StructureCatacombLarge(ElementsXenoclusOne instance) {
		super(instance, 483);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 5000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "catacombbig"));
				if (template == null)
					return;
