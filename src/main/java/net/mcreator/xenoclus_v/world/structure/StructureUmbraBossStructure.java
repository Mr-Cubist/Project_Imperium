...
public class StructureUmbraBossStructure extends ElementsXenoclusOne.ModElement {
	public StructureUmbraBossStructure(ElementsXenoclusOne instance) {
		super(instance, 547);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 3994) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "umbraboss"));
				if (template == null)
					return;
