...
public class StructureUndergroundIceBall extends ElementsXenoclusOne.ModElement {
	public StructureUndergroundIceBall(ElementsXenoclusOne instance) {
		super(instance, 567);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!dimensionCriteria)
			return;
		if ((random.nextInt(1000000) + 1) <= 9898) {
