...
public class StructureMansion1 extends ElementsXenoclusOne.ModElement {
	public StructureMansion1(ElementsXenoclusOne instance) {
		super(instance, 501);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 5000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "mansion1"));
				if (template == null)
					return;
