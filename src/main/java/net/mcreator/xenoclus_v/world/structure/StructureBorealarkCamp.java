...
public class StructureBorealarkCamp extends ElementsXenoclusOne.ModElement {
	public StructureBorealarkCamp(ElementsXenoclusOne instance) {
		super(instance, 626);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 8999) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("xenoclus_v", "ucamp"));
				if (template == null)
					return;
