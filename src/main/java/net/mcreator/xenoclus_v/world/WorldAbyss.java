...
import net.mcreator.xenoclus_v.item.ItemAbyss;
import net.mcreator.xenoclus_v.block.BlockTrenchSand;
import net.mcreator.xenoclus_v.block.BlockMalgea;
import net.mcreator.xenoclus_v.block.BlockAbyssalStone;
import net.mcreator.xenoclus_v.block.BlockAbyssalScaltoneBricks;
...
public class WorldAbyss extends ElementsXenoclusOne.ModElement {
	public static int DIMID = 6;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("xenoclus_v:abyss_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldAbyss(ElementsXenoclusOne instance) {
		super(instance, 197);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemAbyss().setUnlocalizedName("abyss").setRegistryName("abyss"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension abyss is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("abyss", "_abyss", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemAbyss.block, 0, new ModelResourceLocation("xenoclus_v:abyss", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("xenoclus_v:theoldone",
					(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(("xenoclus_v:theoldone"))),
					6000, 24000);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag
											? BlockAbyssalScaltoneBricks.block.getDefaultState().getBlock().getDefaultState()
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockAbyssalScaltoneBricks.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("abyss_portal");
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down())
							.getBlock() != BlockAbyssalScaltoneBricks.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockAbyssalScaltoneBricks.block.getDefaultState().getBlock() ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockAbyssalScaltoneBricks.block.getDefaultState().getBlock()) {
								break label56;
							}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockAbyssalStone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockTrenchSand.block.getDefaultState();
		private static final IBlockState STONE3 = BlockMalgea.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:abyssalbasic")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:depthfalls")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:trenchsands")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:abyssalwastes")),};
