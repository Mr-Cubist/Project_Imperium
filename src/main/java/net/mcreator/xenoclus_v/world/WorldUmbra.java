...
import net.mcreator.xenoclus_v.procedure.ProcedureUmbraReachedTEst;
import net.mcreator.xenoclus_v.item.ItemUmbra;
...
public class WorldUmbra extends ElementsXenoclusOne.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("xenoclus_v:umbra_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldUmbra(ElementsXenoclusOne instance) {
		super(instance, 294);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemUmbra().setUnlocalizedName("umbra").setRegistryName("umbra"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension umbra is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("umbra", "_umbra", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemUmbra.block, 0, new ModelResourceLocation("xenoclus_v:umbra", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("xenoclus_v:UmbraSong1",
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureUmbraReachedTEst.executeProcedure($_dependencies);
			}
		}
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? Blocks.BONE_BLOCK.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.BONE_BLOCK.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("umbra_portal");
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.BONE_BLOCK.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.BONE_BLOCK.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.BONE_BLOCK.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.BONE_BLOCK
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockUmbrastone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockUmbraSoil.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:umbraplains")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:autumn")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:peatdesert")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:ebonyforest")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:umbraforest")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:souldesert")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:paintedswamp")),
				Biome.REGISTRY.getObject(new ResourceLocation("xenoclus_v:umbramountains")),};
