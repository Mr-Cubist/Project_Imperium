...
public class BlockDarkStoneSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:darkstoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:darkstoneslab_double")
	public static final Block block_slab_double = null;
	public BlockDarkStoneSlab(ElementsXenoclusOne instance) {
		super(instance, 260);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("darkstoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("darkstoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:darkstoneslab", "inventory"));
	}
	...
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("darkstoneslab");
