...
public class BlockSolFlower extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:solflower")
	public static final Block block = null;
	public BlockSolFlower(ElementsXenoclusOne instance) {
		super(instance, 46);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:solflower", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(1F);
			setLightLevel(0.4F);
			setUnlocalizedName("solflower");
			setRegistryName("solflower");
		}
