...
import net.mcreator.xenoclus_v.item.ItemRuby;
...
public class BlockRubyOre extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:rubyore")
	public static final Block block = null;
	public BlockRubyOre(ElementsXenoclusOne instance) {
		super(instance, 231);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:rubyore", "inventory"));
	}
