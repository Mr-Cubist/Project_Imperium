...
public class BlockBorealSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:borealslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:borealslab_double")
	public static final Block block_slab_double = null;
	public BlockBorealSlab(ElementsXenoclusOne instance) {
		super(instance, 337);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("borealslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("borealslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:borealslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("borealslab");
