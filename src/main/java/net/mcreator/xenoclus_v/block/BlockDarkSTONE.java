...
public class BlockDarkSTONE extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:darkstone")
	public static final Block block = null;
	public BlockDarkSTONE(ElementsXenoclusOne instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:darkstone", "inventory"));
	}
