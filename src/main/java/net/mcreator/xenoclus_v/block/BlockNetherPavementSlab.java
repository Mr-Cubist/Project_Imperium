...
public class BlockNetherPavementSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:netherpavementslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:netherpavementslab_double")
	public static final Block block_slab_double = null;
	public BlockNetherPavementSlab(ElementsXenoclusOne instance) {
		super(instance, 29);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("netherpavementslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("netherpavementslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:netherpavementslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("netherpavementslab");
