...
import net.mcreator.xenoclus_v.item.ItemPomegranate;
...
public class BlockPomegranateTree extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:pomegranatetree")
	public static final Block block = null;
	public BlockPomegranateTree(ElementsXenoclusOne instance) {
		super(instance, 284);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:pomegranatetree", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2.5F);
			setLightLevel(0F);
			setUnlocalizedName("pomegranatetree");
			setRegistryName("pomegranatetree");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemPomegranate.block, (int) (2)));
		}
