...
public class BlockShiverSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:shiverslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:shiverslab_double")
	public static final Block block_slab_double = null;
	public BlockShiverSlab(ElementsXenoclusOne instance) {
		super(instance, 340);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shiverslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("shiverslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:shiverslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("shiverslab");
