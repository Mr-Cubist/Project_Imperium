...
public class BlockAzathothianGrass extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:azathothiangrass")
	public static final Block block = null;
	public BlockAzathothianGrass(ElementsXenoclusOne instance) {
		super(instance, 160);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:azathothiangrass", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("azathothiangrass");
			setRegistryName("azathothiangrass");
		}
