...
public class BlockShadeBrickSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:shadebrickslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:shadebrickslab_double")
	public static final Block block_slab_double = null;
	public BlockShadeBrickSlab(ElementsXenoclusOne instance) {
		super(instance, 257);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shadebrickslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("shadebrickslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:shadebrickslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("shadebrickslab");
