...
public class BlockMoonStrands extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:moonstrands")
	public static final Block block = null;
	public BlockMoonStrands(ElementsXenoclusOne instance) {
		super(instance, 181);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:moonstrands", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(5.5F);
			setLightLevel(1F);
			setUnlocalizedName("moonstrands");
			setRegistryName("moonstrands");
		}
