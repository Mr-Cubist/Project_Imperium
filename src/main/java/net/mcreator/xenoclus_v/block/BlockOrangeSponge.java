...
public class BlockOrangeSponge extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:orangesponge")
	public static final Block block = null;
	public BlockOrangeSponge(ElementsXenoclusOne instance) {
		super(instance, 171);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:orangesponge", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2.5F);
			setLightLevel(0F);
			setUnlocalizedName("orangesponge");
			setRegistryName("orangesponge");
		}
