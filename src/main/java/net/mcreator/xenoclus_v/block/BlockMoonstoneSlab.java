...
public class BlockMoonstoneSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:moonstoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:moonstoneslab_double")
	public static final Block block_slab_double = null;
	public BlockMoonstoneSlab(ElementsXenoclusOne instance) {
		super(instance, 152);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("moonstoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("moonstoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:moonstoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("moonstoneslab");
