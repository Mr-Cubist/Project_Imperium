...
public class BlockPisciusSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:pisciusslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:pisciusslab_double")
	public static final Block block_slab_double = null;
	public BlockPisciusSlab(ElementsXenoclusOne instance) {
		super(instance, 146);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pisciusslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("pisciusslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:pisciusslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("pisciusslab");
