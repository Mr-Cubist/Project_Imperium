...
public class BlockBorealarkDirt extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:borealarkdirt")
	public static final Block block = null;
	public BlockBorealarkDirt(ElementsXenoclusOne instance) {
		super(instance, 299);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("borealarkdirt"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:borealarkdirt", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			...
			setUnlocalizedName("borealarkdirt");
