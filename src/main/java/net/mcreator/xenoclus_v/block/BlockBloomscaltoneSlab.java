...
public class BlockBloomscaltoneSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:bloomscaltoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:bloomscaltoneslab_double")
	public static final Block block_slab_double = null;
	public BlockBloomscaltoneSlab(ElementsXenoclusOne instance) {
		super(instance, 140);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bloomscaltoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("bloomscaltoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:bloomscaltoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("bloomscaltoneslab");
