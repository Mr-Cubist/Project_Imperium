...
public class BlockPastelSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:pastelslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:pastelslab_double")
	public static final Block block_slab_double = null;
	public BlockPastelSlab(ElementsXenoclusOne instance) {
		super(instance, 131);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pastelslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("pastelslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:pastelslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("pastelslab");
