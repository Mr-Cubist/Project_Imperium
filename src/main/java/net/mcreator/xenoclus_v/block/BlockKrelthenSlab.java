...
public class BlockKrelthenSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:krelthenslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:krelthenslab_double")
	public static final Block block_slab_double = null;
	public BlockKrelthenSlab(ElementsXenoclusOne instance) {
		super(instance, 128);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("krelthenslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("krelthenslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:krelthenslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("krelthenslab");
