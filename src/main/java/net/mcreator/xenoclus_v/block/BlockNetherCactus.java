...
public class BlockNetherCactus extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:nethercactus")
	public static final Block block = null;
	public BlockNetherCactus(ElementsXenoclusOne instance) {
		super(instance, 48);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:nethercactus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("nethercactus");
			setRegistryName("nethercactus");
		}
