...
public class BlockAbyssalReeds extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:abyssalreeds")
	public static final Block block = null;
	public BlockAbyssalReeds(ElementsXenoclusOne instance) {
		super(instance, 183);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:abyssalreeds", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(1.5F);
			setLightLevel(0F);
			setUnlocalizedName("abyssalreeds");
			setRegistryName("abyssalreeds");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemFrozenBerry.block, (int) (0)));
		}
