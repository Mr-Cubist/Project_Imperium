...
public class BlockShellOne extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:shellone")
	public static final Block block = null;
	public BlockShellOne(ElementsXenoclusOne instance) {
		super(instance, 158);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:shellone", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(3F);
			setLightLevel(0F);
			setUnlocalizedName("shellone");
			setRegistryName("shellone");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(Items.FLINT, (int) (0)));
		}
