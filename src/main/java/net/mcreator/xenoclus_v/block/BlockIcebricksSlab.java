...
import net.mcreator.xenoclus_v.procedure.ProcedureIceCastleProAchievement;
...
public class BlockIcebricksSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:icebricksslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:icebricksslab_double")
	public static final Block block_slab_double = null;
	public BlockIcebricksSlab(ElementsXenoclusOne instance) {
		super(instance, 350);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("icebricksslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("icebricksslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:icebricksslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("icebricksslab");
		...
		public void onBlockClicked(World world, BlockPos pos, EntityPlayer entity) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureIceCastleProAchievement.executeProcedure($_dependencies);
			}
		}
	}
}
