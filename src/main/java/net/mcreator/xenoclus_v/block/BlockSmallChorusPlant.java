...
public class BlockSmallChorusPlant extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:smallchorusplant")
	public static final Block block = null;
	public BlockSmallChorusPlant(ElementsXenoclusOne instance) {
		super(instance, 49);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:smallchorusplant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0F);
			setUnlocalizedName("smallchorusplant");
			setRegistryName("smallchorusplant");
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(Items.CHORUS_FRUIT, (int) (0)));
		}
