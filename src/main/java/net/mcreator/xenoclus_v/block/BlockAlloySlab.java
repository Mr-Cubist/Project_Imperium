...
public class BlockAlloySlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:alloyslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:alloyslab_double")
	public static final Block block_slab_double = null;
	public BlockAlloySlab(ElementsXenoclusOne instance) {
		super(instance, 346);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("alloyslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("alloyslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:alloyslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("alloyslab");
