...
public class BlockTendrilCoral extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:tendrilcoral")
	public static final Block block = null;
	public BlockTendrilCoral(ElementsXenoclusOne instance) {
		super(instance, 170);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:tendrilcoral", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2.5F);
			setLightLevel(0F);
			setUnlocalizedName("tendrilcoral");
			setRegistryName("tendrilcoral");
		}
