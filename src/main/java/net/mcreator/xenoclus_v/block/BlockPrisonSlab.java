...
public class BlockPrisonSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:prisonslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:prisonslab_double")
	public static final Block block_slab_double = null;
	public BlockPrisonSlab(ElementsXenoclusOne instance) {
		super(instance, 26);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("prisonslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("prisonslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:prisonslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("prisonslab");
