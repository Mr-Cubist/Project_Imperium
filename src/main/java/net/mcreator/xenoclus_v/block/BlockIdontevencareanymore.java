...
public class BlockIdontevencareanymore extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:idontevencareanymore")
	public static final Block block = null;
	public BlockIdontevencareanymore(ElementsXenoclusOne instance) {
		super(instance, 288);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:idontevencareanymore", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("idontevencareanymore");
			setRegistryName("idontevencareanymore");
		}
