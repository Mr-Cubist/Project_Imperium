...
public class BlockUmbraFlower1 extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:umbraflower1")
	public static final Block block = null;
	public BlockUmbraFlower1(ElementsXenoclusOne instance) {
		super(instance, 278);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:umbraflower1", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("umbraflower1");
			setRegistryName("umbraflower1");
		}
