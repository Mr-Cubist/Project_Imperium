...
public class BlockFrozenBerryBush extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:frozenberrybush")
	public static final Block block = null;
	public BlockFrozenBerryBush(ElementsXenoclusOne instance) {
		super(instance, 373);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:frozenberrybush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setHardness(0.3099999999999999F);
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("frozenberrybush");
			setRegistryName("frozenberrybush");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemFrozenBerry.block, (int) (1)));
		}
