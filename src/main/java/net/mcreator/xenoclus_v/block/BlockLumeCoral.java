...
public class BlockLumeCoral extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:lumecoral")
	public static final Block block = null;
	public BlockLumeCoral(ElementsXenoclusOne instance) {
		super(instance, 178);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:lumecoral", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0F);
			setUnlocalizedName("lumecoral");
			setRegistryName("lumecoral");
		}
