...
import net.mcreator.xenoclus_v.item.ItemPoseidoniaFruit;
...
public class BlockPoseidonia extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:poseidonia")
	public static final Block block = null;
	public BlockPoseidonia(ElementsXenoclusOne instance) {
		super(instance, 179);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:poseidonia", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(1F);
			setLightLevel(0F);
			setUnlocalizedName("poseidonia");
			setRegistryName("poseidonia");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemPoseidoniaFruit.block, (int) (2)));
		}
