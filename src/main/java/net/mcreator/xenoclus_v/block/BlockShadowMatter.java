...
public class BlockShadowMatter extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:shadowmatter")
	public static final Block block = null;
	public BlockShadowMatter(ElementsXenoclusOne instance) {
		super(instance, 248);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shadowmatter"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:shadowmatter", "inventory"));
	}
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.SNOW);
			setUnlocalizedName("shadowmatter");
