...
public class BlockRedCoral extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:redcoral")
	public static final Block block = null;
	public BlockRedCoral(ElementsXenoclusOne instance) {
		super(instance, 165);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:redcoral", "inventory"));
	}
