...
public class BlockFallsLinder extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:fallslinder")
	public static final Block block = null;
	public BlockFallsLinder(ElementsXenoclusOne instance) {
		super(instance, 184);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:fallslinder", "inventory"));
	}
				...
				public boolean generate(World world, Random random, BlockPos pos) {
					for (int i = 0; i < 20; ++i) {
						...
						if (world.isAirBlock(blockpos1)) {
							...
							int j = 1 + random.nextInt(random.nextInt(6) + 1);
							j = Math.min(6, j);
							for (int k = 0; k < j; ++k)
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(1.5F);
			setLightLevel(0F);
			setUnlocalizedName("fallslinder");
			setRegistryName("fallslinder");
		}
