...
public class BlockLargeIceSpikes extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:largeicespikes")
	public static final Block block = null;
	public BlockLargeIceSpikes(ElementsXenoclusOne instance) {
		super(instance, 369);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:largeicespikes", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(3.5F);
			setLightLevel(0F);
			setUnlocalizedName("largeicespikes");
			setRegistryName("largeicespikes");
		}
