...
public class BlockAbyssalGrass extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:abyssalgrass")
	public static final Block block = null;
	public BlockAbyssalGrass(ElementsXenoclusOne instance) {
		super(instance, 176);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:abyssalgrass", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(1F);
			setLightLevel(0F);
			setUnlocalizedName("abyssalgrass");
			setRegistryName("abyssalgrass");
		}
