...
public class BlockEbonySlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:ebonyslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:ebonyslab_double")
	public static final Block block_slab_double = null;
	public BlockEbonySlab(ElementsXenoclusOne instance) {
		super(instance, 250);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ebonyslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ebonyslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:ebonyslab", "inventory"));
	}
