...
public class BlockMeatSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:meatslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:meatslab_double")
	public static final Block block_slab_double = null;
	public BlockMeatSlab(ElementsXenoclusOne instance) {
		super(instance, 30);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("meatslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("meatslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:meatslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.CLAY);
			setUnlocalizedName("meatslab");
