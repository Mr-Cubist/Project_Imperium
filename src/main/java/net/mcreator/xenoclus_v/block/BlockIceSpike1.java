...
public class BlockIceSpike1 extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:icespike1")
	public static final Block block = null;
	public BlockIceSpike1(ElementsXenoclusOne instance) {
		super(instance, 367);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:icespike1", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(3F);
			setLightLevel(0F);
			setUnlocalizedName("icespike1");
			setRegistryName("icespike1");
		}
