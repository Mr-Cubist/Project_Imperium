...
public class BlockScaltoneSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:scaltoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:scaltoneslab_double")
	public static final Block block_slab_double = null;
	public BlockScaltoneSlab(ElementsXenoclusOne instance) {
		super(instance, 137);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("scaltoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("scaltoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:scaltoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("scaltoneslab");
