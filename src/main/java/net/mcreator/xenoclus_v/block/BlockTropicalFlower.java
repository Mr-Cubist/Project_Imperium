...
public class BlockTropicalFlower extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:tropicalflower")
	public static final Block block = null;
	public BlockTropicalFlower(ElementsXenoclusOne instance) {
		super(instance, 44);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:tropicalflower", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("tropicalflower");
			setRegistryName("tropicalflower");
		}
