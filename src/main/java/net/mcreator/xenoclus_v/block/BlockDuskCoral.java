...
public class BlockDuskCoral extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:duskcoral")
	public static final Block block = null;
	public BlockDuskCoral(ElementsXenoclusOne instance) {
		super(instance, 174);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:duskcoral", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2.5F);
			setLightLevel(0F);
			setUnlocalizedName("duskcoral");
			setRegistryName("duskcoral");
		}
