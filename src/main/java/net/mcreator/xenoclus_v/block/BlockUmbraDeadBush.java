...
public class BlockUmbraDeadBush extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:umbradeadbush")
	public static final Block block = null;
	public BlockUmbraDeadBush(ElementsXenoclusOne instance) {
		super(instance, 285);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:umbradeadbush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("umbradeadbush");
			setRegistryName("umbradeadbush");
		}
