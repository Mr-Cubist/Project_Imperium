...
public class BlockPaintedSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:paintedslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:paintedslab_double")
	public static final Block block_slab_double = null;
	public BlockPaintedSlab(ElementsXenoclusOne instance) {
		super(instance, 253);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("paintedslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("paintedslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:paintedslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("paintedslab");
