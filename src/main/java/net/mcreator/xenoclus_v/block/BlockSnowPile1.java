...
public class BlockSnowPile1 extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:snowpile1")
	public static final Block block = null;
	public BlockSnowPile1(ElementsXenoclusOne instance) {
		super(instance, 365);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:snowpile1", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(1.5F);
			setLightLevel(0F);
			setUnlocalizedName("snowpile1");
			setRegistryName("snowpile1");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(Items.SNOWBALL, (int) (2)));
		}
