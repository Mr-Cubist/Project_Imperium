...
public class BlockIceSpikes2 extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:icespikes2")
	public static final Block block = null;
	public BlockIceSpikes2(ElementsXenoclusOne instance) {
		super(instance, 368);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:icespikes2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(3F);
			setLightLevel(0F);
			setUnlocalizedName("icespikes2");
			setRegistryName("icespikes2");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(Items.SNOWBALL, (int) (0)));
		}
