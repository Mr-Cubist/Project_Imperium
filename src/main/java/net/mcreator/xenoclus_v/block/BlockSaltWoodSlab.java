...
public class BlockSaltWoodSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:saltwoodslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:saltwoodslab_double")
	public static final Block block_slab_double = null;
	public BlockSaltWoodSlab(ElementsXenoclusOne instance) {
		super(instance, 134);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("saltwoodslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("saltwoodslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:saltwoodslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("saltwoodslab");
