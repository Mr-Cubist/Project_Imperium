...
public class BlockGreenAlgea extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:greenalgea")
	public static final Block block = null;
	public BlockGreenAlgea(ElementsXenoclusOne instance) {
		super(instance, 161);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:greenalgea", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("greenalgea");
			setRegistryName("greenalgea");
		}
