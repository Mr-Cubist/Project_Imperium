...
public class BlockGloomscaltoneslab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:gloomscaltoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:gloomscaltoneslab_double")
	public static final Block block_slab_double = null;
	public BlockGloomscaltoneslab(ElementsXenoclusOne instance) {
		super(instance, 143);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gloomscaltoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("gloomscaltoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:gloomscaltoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("gloomscaltoneslab");
