...
public class BlockCatacombSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:catacombslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:catacombslab_double")
	public static final Block block_slab_double = null;
	public BlockCatacombSlab(ElementsXenoclusOne instance) {
		super(instance, 263);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("catacombslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("catacombslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:catacombslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("catacombslab");
