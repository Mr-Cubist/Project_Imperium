...
public class BlockUmbraFlower3 extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:umbraflower3")
	public static final Block block = null;
	public BlockUmbraFlower3(ElementsXenoclusOne instance) {
		super(instance, 280);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:umbraflower3", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("umbraflower3");
			setRegistryName("umbraflower3");
		}
