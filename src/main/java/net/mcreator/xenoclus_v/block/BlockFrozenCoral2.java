...
public class BlockFrozenCoral2 extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:frozencoral2")
	public static final Block block = null;
	public BlockFrozenCoral2(ElementsXenoclusOne instance) {
		super(instance, 372);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:frozencoral2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2.5F);
			setLightLevel(0F);
			setUnlocalizedName("frozencoral2");
			setRegistryName("frozencoral2");
		}
