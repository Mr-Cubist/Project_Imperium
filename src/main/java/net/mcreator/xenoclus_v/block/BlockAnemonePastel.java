...
public class BlockAnemonePastel extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:anemonepastel")
	public static final Block block = null;
	public BlockAnemonePastel(ElementsXenoclusOne instance) {
		super(instance, 169);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:anemonepastel", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0.6F);
			setUnlocalizedName("anemonepastel");
			setRegistryName("anemonepastel");
		}
