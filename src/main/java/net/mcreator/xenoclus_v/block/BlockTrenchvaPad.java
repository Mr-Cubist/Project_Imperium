...
public class BlockTrenchvaPad extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:trenchvapad")
	public static final Block block = null;
	public BlockTrenchvaPad(ElementsXenoclusOne instance) {
		super(instance, 185);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:trenchvapad", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(1F);
			setLightLevel(0F);
			setUnlocalizedName("trenchvapad");
			setRegistryName("trenchvapad");
		}
