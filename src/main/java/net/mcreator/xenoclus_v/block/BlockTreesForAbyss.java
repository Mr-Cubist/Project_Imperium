...
import net.mcreator.xenoclus_v.procedure.ProcedureTreeChoice;
...
public class BlockTreesForAbyss extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:treesforabyss")
	public static final Block block = null;
	public BlockTreesForAbyss(ElementsXenoclusOne instance) {
		super(instance, 182);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:treesforabyss", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("treesforabyss");
			setRegistryName("treesforabyss");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureTreeChoice.executeProcedure($_dependencies);
			}
		}
