...
public class BlockAnemoneDeep extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:anemonedeep")
	public static final Block block = null;
	public BlockAnemoneDeep(ElementsXenoclusOne instance) {
		super(instance, 180);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:anemonedeep", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(1F);
			setUnlocalizedName("anemonedeep");
			setRegistryName("anemonedeep");
		}
