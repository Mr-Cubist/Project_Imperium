...
public class BlockUmbraTallGrass extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:umbratallgrass")
	public static final Block block = null;
	public BlockUmbraTallGrass(ElementsXenoclusOne instance) {
		super(instance, 276);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:umbratallgrass", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("umbratallgrass");
			setRegistryName("umbratallgrass");
		}
