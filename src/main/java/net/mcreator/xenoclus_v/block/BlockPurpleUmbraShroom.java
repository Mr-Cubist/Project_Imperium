...
public class BlockPurpleUmbraShroom extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:purpleumbrashroom")
	public static final Block block = null;
	public BlockPurpleUmbraShroom(ElementsXenoclusOne instance) {
		super(instance, 282);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:purpleumbrashroom", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("purpleumbrashroom");
			setRegistryName("purpleumbrashroom");
		}
