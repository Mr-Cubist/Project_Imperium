...
public class BlockOldReefRock extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:oldreefrock")
	public static final Block block = null;
	public BlockOldReefRock(ElementsXenoclusOne instance) {
		super(instance, 99);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("oldreefrock"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:oldreefrock", "inventory"));
	}
			...
			(new WorldGenMinable(block.getDefaultState(), 20, new com.google.common.base.Predicate<IBlockState>() {
				public boolean apply(IBlockState blockAt) {
					...
					if (blockAt.getBlock() == BlockWhiteSand.block.getDefaultState().getBlock())
						blockCriteria = true;
					if (blockAt.getBlock() == BlockGreenAlgeaGrass.block.getDefaultState().getBlock())
						blockCriteria = true;
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("oldreefrock");
