...
public class BlockFrostedbricksslab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:frostedbricksslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:frostedbricksslab_double")
	public static final Block block_slab_double = null;
	public BlockFrostedbricksslab(ElementsXenoclusOne instance) {
		super(instance, 343);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("frostedbricksslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("frostedbricksslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:frostedbricksslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("frostedbricksslab");
