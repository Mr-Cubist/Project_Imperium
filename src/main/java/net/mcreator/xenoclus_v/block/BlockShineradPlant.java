...
public class BlockShineradPlant extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:shineradplant")
	public static final Block block = null;
	public BlockShineradPlant(ElementsXenoclusOne instance) {
		super(instance, 186);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:shineradplant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(1F);
			setUnlocalizedName("shineradplant");
			setRegistryName("shineradplant");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockLumiGrass.block, (int) (0)));
		}
