...
public class BlockPaintedWoodPlaceable extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:paintedwoodplaceable")
	public static final Block block = null;
	public BlockPaintedWoodPlaceable(ElementsXenoclusOne instance) {
		super(instance, 212);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("paintedwoodplaceable"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:paintedwoodplaceable", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("paintedwoodplaceable");
