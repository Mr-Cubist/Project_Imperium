...
public class BlockFrostedConcrete extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:frostedconcrete")
	public static final Block block = null;
	public BlockFrostedConcrete(ElementsXenoclusOne instance) {
		super(instance, 305);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("frostedconcrete"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:frostedconcrete", "inventory"));
	}
		...
		for (int i = 0; i < 21; i++) {
			...
			(new WorldGenMinable(block.getDefaultState(), 20, new com.google.common.base.Predicate<IBlockState>() {
				public boolean apply(IBlockState blockAt) {
					...
					IBlockState require;
					if (blockAt.getBlock() == BlockSnowySoftStone.block.getDefaultState().getBlock())
						blockCriteria = true;
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("frostedconcrete");
