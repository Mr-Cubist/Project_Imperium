...
public class BlockPalmSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:palmslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:palmslab_double")
	public static final Block block_slab_double = null;
	public BlockPalmSlab(ElementsXenoclusOne instance) {
		super(instance, 23);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("palmslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("palmslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:palmslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("palmslab");
