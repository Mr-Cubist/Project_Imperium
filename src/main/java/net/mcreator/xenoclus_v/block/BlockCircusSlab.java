...
public class BlockCircusSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:circusslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:circusslab_double")
	public static final Block block_slab_double = null;
	public BlockCircusSlab(ElementsXenoclusOne instance) {
		super(instance, 266);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("circusslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("circusslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:circusslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("circusslab");
