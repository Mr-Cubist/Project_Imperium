...
public class BlockOrangeCoral extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:orangecoral")
	public static final Block block = null;
	public BlockOrangeCoral(ElementsXenoclusOne instance) {
		super(instance, 166);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:orangecoral", "inventory"));
	}
