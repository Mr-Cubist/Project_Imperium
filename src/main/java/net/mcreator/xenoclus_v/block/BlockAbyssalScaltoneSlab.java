...
public class BlockAbyssalScaltoneSlab extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:abyssalscaltoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("xenoclus_v:abyssalscaltoneslab_double")
	public static final Block block_slab_double = null;
	public BlockAbyssalScaltoneSlab(ElementsXenoclusOne instance) {
		super(instance, 149);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("abyssalscaltoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("abyssalscaltoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:abyssalscaltoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("abyssalscaltoneslab");
