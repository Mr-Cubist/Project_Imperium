...
public class BlockEndBell extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:endbell")
	public static final Block block = null;
	public BlockEndBell(ElementsXenoclusOne instance) {
		super(instance, 52);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:endbell", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0.56F);
			setUnlocalizedName("endbell");
			setRegistryName("endbell");
		}
