...
public class BlockGreenAlgeaWa extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:greenalgeawa")
	public static final Block block = null;
	public BlockGreenAlgeaWa(ElementsXenoclusOne instance) {
		super(instance, 651);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:greenalgeawa", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("greenalgeawa");
			setRegistryName("greenalgeawa");
		}
