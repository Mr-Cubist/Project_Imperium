...
public class BlockUmbraFlower2 extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:umbraflower2")
	public static final Block block = null;
	public BlockUmbraFlower2(ElementsXenoclusOne instance) {
		super(instance, 279);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:umbraflower2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("umbraflower2");
			setRegistryName("umbraflower2");
		}
