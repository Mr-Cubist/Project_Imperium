...
public class BlockYellowCoral extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:yellowcoral")
	public static final Block block = null;
	public BlockYellowCoral(ElementsXenoclusOne instance) {
		super(instance, 167);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("xenoclus_v:yellowcoral", "inventory"));
	}
