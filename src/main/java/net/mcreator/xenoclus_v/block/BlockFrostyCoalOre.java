...
public class BlockFrostyCoalOre extends ElementsXenoclusOne.ModElement {
	@GameRegistry.ObjectHolder("xenoclus_v:frostycoalore")
	public static final Block block = null;
	public BlockFrostyCoalOre(ElementsXenoclusOne instance) {
		super(instance, 313);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("frostycoalore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("xenoclus_v:frostycoalore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("frostycoalore");
